...
- [If You Only Read Five Repos](#if-you-only-read-five-repos)
- [Harness Layer Map](#harness-layer-map)
- [1. Harness-First Runtimes and Coding Agents](#1-harness-first-runtimes-and-coding-agents)
- [2. Frameworks, Planning, Orchestration, and Agent Protocols](#2-frameworks-planning-orchestration-and-agent-protocols)
- [3. Skills and Reusable Behavior Packs](#3-skills-and-reusable-behavior-packs)
- [4. MCP and Capability Fabric](#4-mcp-and-capability-fabric)
- [5. Memory, State, and Context Systems](#5-memory-state-and-context-systems)
- [6. Browser, Sandbox, Execution, and Operator Surfaces](#6-browser-sandbox-execution-and-operator-surfaces)
- [7. Observability, Evals, and Guardrails](#7-observability-evals-and-guardrails)
- [8. Reference Harness Compositions](#8-reference-harness-compositions)
- [Related Research in This Repo](#related-research-in-this-repo)
...
>
> See [Skills Security, Operations, and FAQ](#skills-security-operations-and-faq) for more information.
...
- **Runtime layer**: [openai/codex](https://github.com/openai/codex) or [anomalyco/opencode](https://github.com/anomalyco/opencode)
- **Capability layer**: [github/github-mcp-server](https://github.com/github/github-mcp-server)
- **Browser / execution layer**: [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp)
- **Eval layer**: [promptfoo/promptfoo](https://github.com/promptfoo/promptfoo)
- **Observability layer**: [langfuse/langfuse](https://github.com/langfuse/langfuse)
...
- **Runtime / framework layer**: [langchain-ai/deepagents](https://github.com/langchain-ai/deepagents) or [lastmile-ai/mcp-agent](https://github.com/lastmile-ai/mcp-agent)
- **Protocol layer**: [modelcontextprotocol/modelcontextprotocol](https://github.com/modelcontextprotocol/modelcontextprotocol)
- **Registry layer**: [modelcontextprotocol/servers](https://github.com/modelcontextprotocol/servers)
- **Memory layer**: [mem0ai/mem0](https://github.com/mem0ai/mem0) or [getzep/graphiti](https://github.com/getzep/graphiti)
- **Observability / eval layer**: [Arize-ai/phoenix](https://github.com/Arize-ai/phoenix)

### 3. Security-First Harness

Best when approval, isolation, scanning, and secure workflows matter more than raw autonomy.

- **Runtime layer**: [cline/cline](https://github.com/cline/cline) or [block/goose](https://github.com/block/goose)
- **Skills / behavior layer**: [trailofbits/skills](https://github.com/trailofbits/skills)
- **Guardrails layer**: [invariantlabs-ai/invariant](https://github.com/invariantlabs-ai/invariant)
- **MCP inspection layer**: [invariantlabs-ai/mcp-scan](https://github.com/invariantlabs-ai/mcp-scan)
- **Eval layer**: [promptfoo/promptfoo](https://github.com/promptfoo/promptfoo)
